...
--
-- Host: localhost    Database: eshleepy
-- ------------------------------------------------------
...
CREATE TABLE `orden_detalle` (
  `id_ordendetalle` int NOT NULL AUTO_INCREMENT,
  `id_orden` int DEFAULT NULL,
  `id_producto` int DEFAULT NULL,
  `precio_orden` float DEFAULT NULL,
  PRIMARY KEY (`id_ordendetalle`),
  UNIQUE KEY `id_ordendetalle_UNIQUE` (`id_ordendetalle`),
...
CREATE TABLE `roles` (
  ...
  KEY `id_fk_usuario_idx` (`id_usuario`),
  KEY `id_admin_idx` (`id_admin`),
  CONSTRAINT `id_admin` FOREIGN KEY (`id_admin`) REFERENCES `admin` (`id_admin`),
  CONSTRAINT `id_fk_usuario` FOREIGN KEY (`id_usuario`) REFERENCES `usuarios` (`id_usuario`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-06-08 21:15:14
