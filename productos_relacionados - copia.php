<h3 class="text-center padding-top-2x mt-2 padding-bottom-1x"><?=$texto[25]?></h3>
		...
		<?php  $relat=mysqli_query($link,"select * from productos where id_categoria=".$producto["id_categoria"]." and id not in(".$producto["id"].") and estatus='si' order by orden ASC");
